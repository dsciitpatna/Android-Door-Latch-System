...
public class MainActivity extends AppCompatActivity {
    ...
    DatabaseReference read_switch_status;

    ToggleButton sensor_status_button;
    ToggleButton read_switch_button;
 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read_switch_button = findViewById(R.id.read_switch_status);
        ...
        read_switch_status = database.getReference( "read_switch_status");
        context = this;
        ...
        sensor_status_button.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton b, boolean checked) {
                if (checked) {
                    ...
                    Log.w(TAG, "sensor:- checked");

                } else {
                    sensor_status.setValue(false);
                    Log.w(TAG, "sensor:- unchecked");
                }
            }
        });

        read_switch_button.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton b, boolean checked) {
                if (checked) {
                    read_switch_status.setValue(true);
                    Log.w(TAG, "read switch:- checked");

                } else {
                    read_switch_status.setValue(false);
                    Log.w(TAG, "read switch:- unchecked");
                }
            }
        });
    }
